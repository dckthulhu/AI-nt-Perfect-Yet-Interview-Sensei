...
def initialize_session_state_jd():
    ...
    if "jd_history" not in st.session_state:
        ...
        st.session_state.jd_history.append(Message("ai",
                                                   "Hello there! I am your interviewer today. I will access your technical fit through a series of questions. Let's get started! Please start by saying hello or introducing yourself. Note: The maximum length of your answer is ~900 words"))
    # token count
